const Hero = () => {
  return (
    <section
      id="hero"
      className="w-full relative overflow-hidden bg-[#05172A] md:min-h-screen"
    ...
    >
      ...
      {/* Top fade — mobile only, hides empty bg-contain space at top */}
      <div className="hero-top-fade absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-[#05172A] to-transparent pointer-events-none" />
