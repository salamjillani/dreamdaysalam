...
const Navigation = ({ activeSection, scrollToSection, setShowConsultationForm }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 bg-[#003151] border-b border-[#FEACC6]/20">
      ...
      >
        <div className="px-4 pt-2 pb-4 space-y-1 bg-[#003151] border-t border-[#FEACC6]/20">
          {navigationItems.map(({ id, label }) => (
            <button
              key={id}
